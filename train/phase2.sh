CLIP_HIGH=0.3
LR=5e-7
SCORE_MODE=full_pass  # full pass rate
ENABLE_FEEDBACK=False
ENABLE_EXPERIENCE_REPLAY=False
SQLITE_LOGGING=True
TRAIN_LIST="manufactoria/has_train 1.0"
EVAL_LIST="manufactoria/has_test 50"
DESCRIPTION="manufactoria_has_full-pass-rate"
EXP_NAME=Qwen3_4B_Instruct_manufactoria_has_full-pass-rate
BASE_MODEL= # CHECKPOINT PATH AFTER PHASE 1
